...
% save for SIGCSE/TOCE?
%\title{Technocamps: A Decade of Supporting\\Computer Science
%Education in Wales}

% Old title: Ailfeddwl Cyfrifiadureg yn Ysgolion Cymru\\(or: Rethinking Computer Science in Welsh Schools)
...
(Section~\ref{welshukedu}), particularly in relation to computing
education. We highlight the recent and onoing education policy changes in Wales
(Section~\ref{welshedurefom} and a consideration of the challenges
remaining in computing education in Wales
(Section~\ref{conclusions}), offering a engaging national case
study...etc etc.
...
Wales is a small nation to the west of England; it has an ancient
...
east corner (including its capital Cardiff, with a population of
c.325,000) and the regions bordering England, the rest of the country
...
Stages used in England, the Welsh
Government embarked on a 10-year revolutionary plan including phasing
out national Standard Attainment Tests (SATs), introducing the Welsh
...
\section{Computing and Educational\\Reform in Wales}\label{welshedurefom}
...
\subsection{Technocamps and CAS}
...
to run Technocamps as a pan-Wales project with regional hubs at the
Universities of Aberystwyth, Bangor and Glamorgan (now University of
South Wales), with Technocamps hubs subsequently being set up at most
of the remaining major Universities in Wales, specifically Cardiff
University, Cardiff Metropolitan University, and Glynd\^wr University
in Wrexham (see~\cite{crick+moller-wipsce2015} for a in-depth
discussion of the Technocamps project). Though focusing on the
children, Technocamps also provides ``Technoteach'' events aimed at
up-skilling ICT teachers in Wales.  Technocamps has since provided
computer science-related activities and resources for tens of
thousands of young people across Wales, as well as interacting with
hundreds of teachers across hundreds of the nation's schools.
...
\section{Wales Divided -- Measuring Impact}\label{walesdivided}
...
impact of Technocamps, as the country was invariably divided into two
halves: West Wales and the Valleys receiving the full Technocamps
experience, whilst East Wales (including its capital, Cardiff) did
not\footnote{In fact, the Convergence area encompasses closer to
two-thirds of Wales, measured both in population and area.}.
...
across Wales are led by academics in university-based Technocamps
Hubs.  Teachers have generally not been as self-organising in Wales
compared to England to directly promote the wider CAS agenda to
support curriculum reform and building a teacher-led
community~\cite{crick+moller-wipsce2015}.
...
engagement with initiatives such as Technocamps.
